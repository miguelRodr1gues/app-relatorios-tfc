    ...
    return (
        <div className="flex-1 overflow-y-auto px-8 py-8 bg-[#fafafa] dark:bg-[#1a1a1a]">
            ...
            <div className="space-y-6">
                {/* Appearance Section */}
                <div
                    className="bg-white dark:bg-[#2a2a2a] rounded-[20px] shadow-sm border border-[#f3f4f6] dark:border-[#3a3a3a] overflow-hidden">
                ...
                />
                        ...
                        <div
                            className="flex items-center justify-between pt-4 border-t border-[#f3f4f6] dark:border-[#3a3a3a]">
                            <div className="flex items-center gap-3">
                    ...
                    <div className="px-6 py-5 space-y-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <Globe
                                    className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#9ca3af] dark:text-[#6b7280]"/>
                                <select
                                    className="w-full pl-11 pr-4 py-2.5 bg-white dark:bg-[#1a1a1a] border border-[#e5e7eb] dark:border-[#3a3a3a] rounded-full text-[14px] text-[#1f2937] dark:text-white focus:outline-none focus:border-[#2d6a4f] focus:ring-2 focus:ring-[#2d6a4f]/20 transition-all appearance-none cursor-pointer">
                ...
                <div
                    ...
                    <div className="px-6 py-5">
                        <button
                            className="w-full px-4 py-2.5 bg-white dark:bg-[#1a1a1a] border border-[#e5e7eb] dark:border-[#3a3a3a] rounded-full text-[14px] font-medium text-[#1f2937] dark:text-white hover:bg-[#f9fafb] dark:hover:bg-[#2a2a2a] transition-all">
                            Alterar Password
                        </button>
                    </div>
                </div>
                ...
                <div className="flex justify-end pt-4">
                    <button
                        className="flex items-center gap-2 bg-[#2d6a4f] text-white border-none rounded-full px-8 py-3 text-[14px] font-semibold cursor-pointer transition-all hover:bg-[#1b4332] hover:shadow-md">
